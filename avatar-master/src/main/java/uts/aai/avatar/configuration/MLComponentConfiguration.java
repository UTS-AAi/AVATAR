...
public class MLComponentConfiguration {
    ...
    public static List<MLComponent> initConfiguration() {
        ...
        listOfMLComponents.addAll(initBaseLeanersComponents());
        listOfMLComponents.addAll(initAttributeSelectionComponents());
...
//        {
//            String componentId = "weka.attributeSelection.WrapperSubsetEval";
//            String componentName = "WrapperSubsetEval";
//            String componentFullClassName = "weka.attributeSelection.WrapperSubsetEval";
//            MLComponentType mLComponentType = MLComponentType.EVALUATOR_ATT;
//            String componentExecutionScript = "weka.attributeSelection.WrapperSubsetEval -B weka.classifiers.rules.ZeroR -F 5 -T 0.01 -R 1 -E acc --";
...
//        
...

        {
...

            {
                ...
                hp.setDefaultConfigString("weka.classifiers.functions.supportVector.PolyKernel");
                listOfHyperparameters.add(hp);
            }
...

        {
            ...
            String componentExecutionScript = "weka.classifiers.lazy.LWL -U 0 -K -1 -A \"weka.core.neighboursearch.LinearNNSearch -A \\\"weka.core.EuclideanDistance -R first-last\\\"\" -W #PREDICTOR_CONFIG#";
            String componentExecutionScriptFilteredClassifierWeka = "";
            List<MLHyperparameter> listOfHyperparameters = new ArrayList<>();
...

            {
                ...
                hp.setDefaultConfigString("weka.classifiers.trees.DecisionStump");
                listOfHyperparameters.add(hp);
            }
        ...
        ///////////////////////////////////////////////
        {
            ...
            MLComponentType mLComponentType = MLComponentType.META_PREDICTOR;
            String componentExecutionScript = "weka.classifiers.meta.AdaBoostM1 -P 100 -S 1 -I 10 -W #PREDICTOR_CONFIG#";
            String componentExecutionScriptFilteredClassifierWeka = "";
...

        {
            ...
            MLComponentType mLComponentType = MLComponentType.META_PREDICTOR;
            String componentExecutionScript = "weka.classifiers.meta.AttributeSelectedClassifier -E \"weka.attributeSelection.CfsSubsetEval \" -S \"weka.attributeSelection.BestFirst -D 1 -N 5\" -W #PREDICTOR_CONFIG#";
            String componentExecutionScriptFilteredClassifierWeka = "";
        ...
        }
        {
            ...
            MLComponentType mLComponentType = MLComponentType.META_PREDICTOR;
            String componentExecutionScript = "weka.classifiers.meta.Bagging -P 100 -S 1 -num-slots 1 -I 10 -W #PREDICTOR_CONFIG#";
            String componentExecutionScriptFilteredClassifierWeka = "";
            List<MLHyperparameter> listOfHyperparameters = new ArrayList<>();
            ...
            {
                MLHyperparameter hp = new MLHyperparameter("-W", MLHyperparameterType.PREDICTORS);
                hp.setDefaultConfigString("weka.classifiers.trees.REPTree");
                listOfHyperparameters.add(hp);
            }
...

        {
            ...
            MLComponentType mLComponentType = MLComponentType.META_PREDICTOR;
            String componentExecutionScript = "weka.classifiers.meta.ClassificationViaRegression -W #PREDICTOR_CONFIG#";
            String componentExecutionScriptFilteredClassifierWeka = "";
            ...
            {
                MLHyperparameter hp = new MLHyperparameter("-W", MLHyperparameterType.PREDICTORS);
                hp.setDefaultConfigString("weka.classifiers.trees.M5P");
                listOfHyperparameters.add(hp);
            }
...
//        }
        {
            ...
            MLComponentType mLComponentType = MLComponentType.META_PREDICTOR;
            String componentExecutionScript = "weka.classifiers.meta.LogitBoost -P 100 -F 0 -R 1 -L -1.7976931348623157E308 -H 1.0 -S 1 -I 10 -W #PREDICTOR_CONFIG#";
            String componentExecutionScriptFilteredClassifierWeka = "";
            List<MLHyperparameter> listOfHyperparameters = new ArrayList<>();
...
//        }
        {
            ...
            MLComponentType mLComponentType = MLComponentType.META_PREDICTOR;
            String componentExecutionScript = "weka.classifiers.meta.RandomSubSpace -P 0.5 -S 1 -num-slots 1 -I 10 -W #PREDICTOR_CONFIG#";
            String componentExecutionScriptFilteredClassifierWeka = "";
...
//        }
    ...
    public static List<MLComponent> initAttributeSelectionComponents() {
        List<MLComponent> listOfMLComponentByType = new ArrayList<>();

        {
            String componentId = "weka.filters.supervised.attribute.AttributeSelection";
            String componentName = "AttributeSelection";
            String componentFullClassName = "weka.filters.supervised.attribute.AttributeSelection";
            MLComponentType mLComponentType = MLComponentType.ATTRIBUTE_SELECTION;
            String componentExecutionScript = "weka.filters.supervised.attribute.AttributeSelection -E \"weka.attributeSelection.CfsSubsetEval \" -S \"weka.attributeSelection.BestFirst -D 1 -N 5\"";
            String componentExecutionScriptFilteredClassifierWeka = "";
            List<MLHyperparameter> listOfHyperparameters = new ArrayList<>();

            {
                MLHyperparameter hp = new MLHyperparameter("-E", MLHyperparameterType.EVALUATOR);
                hp.setDefaultConfigString("weka.attributeSelection.CfsSubsetEval");
                listOfHyperparameters.add(hp);
            }

            {
                MLHyperparameter hp = new MLHyperparameter("-S", MLHyperparameterType.SEARCH_METHOD);
                hp.setDefaultConfigString("weka.attributeSelection.BestFirst");
                listOfHyperparameters.add(hp);
            }
    ...
    public static List<MLComponent> initBaseLeanersComponents() {
    ...
    public static List<MLComponent> initEvaluatorComponentsforAttributeSelection() {
        ...
        ///////////////////////////////////////////////
        {
            String componentId = "weka.attributeSelection.CfsSubsetEval";
            String componentName = "CfsSubsetEval";
            String componentFullClassName = "weka.attributeSelection.CfsSubsetEval";
            MLComponentType mLComponentType = MLComponentType.EVALUATOR_ATT;
            String componentExecutionScript = "weka.attributeSelection.CfsSubsetEval";
            String componentExecutionScriptFilteredClassifierWeka = "";
        ...
        {
            String componentId = "weka.attributeSelection.CorrelationAttributeEval";
            String componentName = "CorrelationAttributeEval";
            String componentFullClassName = "weka.attributeSelection.CorrelationAttributeEval";
            MLComponentType mLComponentType = MLComponentType.EVALUATOR_ATT;
            String componentExecutionScript = "weka.attributeSelection.CorrelationAttributeEval";
            String componentExecutionScriptFilteredClassifierWeka = "";
        ...
        {
            String componentId = "weka.attributeSelection.GainRatioAttributeEval";
            String componentName = "GainRatioAttributeEval";
            String componentFullClassName = "weka.attributeSelection.GainRatioAttributeEval";
            MLComponentType mLComponentType = MLComponentType.EVALUATOR_ATT;
            String componentExecutionScript = "weka.attributeSelection.GainRatioAttributeEval";
            String componentExecutionScriptFilteredClassifierWeka = "";
        ...
        {
            String componentId = "weka.attributeSelection.OneRAttributeEval";
            String componentName = "OneRAttributeEval";
            String componentFullClassName = "weka.attributeSelection.OneRAttributeEval";
            MLComponentType mLComponentType = MLComponentType.EVALUATOR_ATT;
            String componentExecutionScript = "weka.attributeSelection.OneRAttributeEval -S 1 -F 10 -B 6";
            String componentExecutionScriptFilteredClassifierWeka = "";
        ...
        {
            String componentId = "weka.attributeSelection.PrincipalComponents";
            String componentName = "PrincipalComponents";
            String componentFullClassName = "weka.attributeSelection.PrincipalComponents";
            MLComponentType mLComponentType = MLComponentType.EVALUATOR_ATT;
            String componentExecutionScript = "weka.attributeSelection.PrincipalComponents -R 0.95 -A 5";
            String componentExecutionScriptFilteredClassifierWeka = "";
        ...
        {
            String componentId = "weka.attributeSelection.ReliefFAttributeEval";
            String componentName = "ReliefFAttributeEval";
            String componentFullClassName = "weka.attributeSelection.ReliefFAttributeEval";
            MLComponentType mLComponentType = MLComponentType.EVALUATOR_ATT;
            String componentExecutionScript = "weka.attributeSelection.ReliefFAttributeEval -M -1 -D 1 -K 10";
            String componentExecutionScriptFilteredClassifierWeka = "";
            ...
            {
                MLHyperparameter hp = new MLHyperparameter("-D", MLHyperparameterType.INTEGER);
                hp.setMinIntValue(1);
                hp.setMaxIntValue(1);
                hp.setDefaultIntValue(1);
                listOfHyperparameters.add(hp);
        ...
        {
            String componentId = "weka.attributeSelection.SymmetricalUncertAttributeEval";
            String componentName = "SymmetricalUncertAttributeEval";
            String componentFullClassName = "weka.attributeSelection.SymmetricalUncertAttributeEval";
            MLComponentType mLComponentType = MLComponentType.EVALUATOR_ATT;
            String componentExecutionScript = "weka.attributeSelection.SymmetricalUncertAttributeEval";
            String componentExecutionScriptFilteredClassifierWeka = "";
    ...
    public static List<MLComponent> initSearchMethodComponentsforAttributeSelection() {
        ...
        ///////////////////////////////////////////////
        {
            String componentId = "weka.attributeSelection.BestFirst";
            String componentName = "BestFirst";
            String componentFullClassName = "weka.attributeSelection.BestFirst";
            MLComponentType mLComponentType = MLComponentType.SEARCH_METHOD_ATT;
            String componentExecutionScript = "weka.attributeSelection.BestFirst -D 1 -N 5";
            String componentExecutionScriptFilteredClassifierWeka = "";
        ...
        {
            String componentId = "weka.attributeSelection.GreedyStepwise";
            String componentName = "GreedyStepwise";
            String componentFullClassName = "weka.attributeSelection.GreedyStepwise";
            MLComponentType mLComponentType = MLComponentType.SEARCH_METHOD_ATT;
            String componentExecutionScript = "weka.attributeSelection.GreedyStepwise -T -1.7976931348623157E308 -N -1";
            String componentExecutionScriptFilteredClassifierWeka = "";
        ...
        {
            String componentId = "weka.attributeSelection.Ranker";
            String componentName = "Ranker";
            String componentFullClassName = "weka.attributeSelection.Ranker";
            MLComponentType mLComponentType = MLComponentType.SEARCH_METHOD_ATT;
            String componentExecutionScript = "weka.attributeSelection.Ranker -T -1.7976931348623157E308 -N -1";
            String componentExecutionScriptFilteredClassifierWeka = "";
...
//        }
    ...
    public static AlgorithmConfiguration getAlgorithmConfiguration(String algorithm, List<MLComponent> loadedListOfMLComponents) {
        ...
        String[] algorithmConfigs = algorithm.split("~");
        ...
        if (algorithmConfigs.length >= 2) {
            ...
            mLComponent = getComponentByID(algorithm, loadedListOfMLComponents);
        }
